## Get the last password change date and disable account date
```
...
| project AccountUpn, AccountDisplayName, SourceProvider, Timestamp, AccountDisabledTime, PasswordChangedTime
```
